...
urlpatterns = [
    ...
    path('crm/mes-clients/', crm_my_clients, name='crm_my_clients'),
    path('crm/mes-clients/legacy/', crm_my_clients, name='crm_portfolio'),
    path('crm/vente/jour/', crm_vente, {'period': 'jour'}, name='crm_vente_day'),
    path('crm/vente/mois/', crm_vente, {'period': 'mois'}, name='crm_vente_month'),
    path('crm/vente/annee/', crm_vente, {'period': 'annee'}, name='crm_vente_year'),
